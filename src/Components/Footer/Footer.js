	...
	<footer class="footer-wrapper">
		<div class="container"> 
			<div class="upper-text-container">
				...
				<p>2. Subscription required.<br></br><br></br>
				Magic Keyboard sold separately.<br></br><br></br>
			...
			<div class="copyright-wrapper row">
				...
				<div class="footer-country  col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3">
					<div class="flag-wrapper"><img src={icon16}></img></div> <div class="footer-country-name">United States</div> 
				</div>
			</div>
		</div>
	</footer> 
